...
public class adminhome extends HttpServlet {
    ...
    {
         try{
                HttpSession hs=request.getSession(false);//existence of session
                if(hs==null)
                {
                ...
                out.write("<html><style>a{font-weight:bold;font-size:2em;color:white}</style><body background='blu.jpg'>");
                out.write("<img src='images.jpg' width='100%' height='250px'><hr><br><br><br><br><br><br>");
                ...
                out.write("<hr><img src='sun.jpg' width='100%' height='250px'>");
                out.write("</body></html>");
        }catch(Exception ee){}
    }
