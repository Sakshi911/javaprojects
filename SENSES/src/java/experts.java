 ...
 * @author DELL
 */
@WebServlet(urlPatterns = {"/experts"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
    {
        try{
                ...
                if(request.getParameter("b3")!=null)
                {
                    ...
                    stmt=con.prepareStatement("Insert into experts values(?,?,?,?,?)");
                    ...
                    stmt.executeUpdate();
                    stmt=con.prepareStatement("Insert into users values(?,?,'expert')");
                    stmt.setString(1,request.getParameter("t1"));
                    stmt.setString(2,request.getParameter("t11"));
                    stmt.executeUpdate();
                    con.close();
                    msg="Thanks for Registration.<br>We appreciate your efforts to help People.<br>Please <a href='login'>Login</a> to Continue.";
                }
                ...
                out.write("<tr><td>Highest Qualification:</td><td><select name='t3'><option>Graduate</option><option>Post Graduate</option><option>Doctorate</option><option>Other</option></select></td><td></td></tr>");
                out.write("<tr><td>Experience:</td><td><input type='text'></td><td>Years</td><td></td></tr>");
                out.write("<tr><td>Expertise:</td><td><input type='text' name='t5'></td><td></td></tr>");
                out.write("<tr><td></td><td><input type=submit name='b3' value='Register'></td><td></td></tr>");
